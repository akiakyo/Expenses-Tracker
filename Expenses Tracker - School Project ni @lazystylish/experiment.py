...
from tkinter import Tk, Canvas, Entry, Button, PhotoImage, StringVar, OptionMenu, Listbox, END, messagebox
...
def open_main_window():
    ...
    def update_totals():
        nonlocal income, expenses, balance
    ...
    def submit_handler():
        ...
        try:
            transaction_amt = float(entry_2.get())
    ...
    def reset_all():
        nonlocal income, expenses, balance, transactions, transaction_id
        income = 0
        expenses = 0
        balance = 0
        transactions = []
    ...
    canvas.create_rectangle(0.0, 0.0, 800.0, 85.0, fill="#292C7B", outline="")
    ...
    canvas.create_text(36.0, 285.0, anchor="nw", text="Add Transaction", fill="#002689", font=("MontserratRoman Bold", 16 * -1))
    canvas.create_text(36.0, 317.0, anchor="nw", text="Category :", fill="#002689", font=("MontserratRoman Bold", 12 * -1))
    canvas.create_text(37.0, 392.0, anchor="nw", text="Amount ($)", fill="#002689", font=("MontserratRoman Bold", 12 * -1))
    canvas.create_text(37.0, 467.0, anchor="nw", text="Type of Transaction :", fill="#002689", font=("MontserratRoman Bold", 12 * -1))
    canvas.create_text(37.0, 542.0, anchor="nw", text="Date :", fill="#002689", font=("MontserratRoman Bold", 12 * -1))

    # Entry fields for transactions
    entry_image_1 = PhotoImage(file=relative_to_assets("entry_2.png"))
    entry_bg_1 = canvas.create_image(215.5, 362.0, image=entry_image_1)
    ...
    # Reset button
    reset_button = Button(
        text="Reset All", command=reset_all, bg="#4CC9F0", fg="#FFFFFF", relief="flat"
    )
...
canvas_login = Canvas(login_window, bg="#00001a", height=250, width=300)
canvas_login.pack()

canvas_login.create_text(150, 40, text="Login", fill="#002689", font=("MontserratRoman Bold", 20))

canvas_login.create_text(50, 80, text="Username:", fill="#002689", font=("MontserratRoman", 12))
entry_username = Entry(login_window)
entry_username.place(x=120, y=65, width=150)

canvas_login.create_text(50, 120, text="Password:", fill="#002689", font=("MontserratRoman", 12))
entry_password = Entry(login_window, show="*")
entry_password.place(x=120, y=105, width=150)

login_button = Button(
    login_window, text="Login", command=check_login, bg="#FFA500", fg="#FFFFFF", relief="flat"
)
login_button.place(x=100, y=150, width=100, height=40)
