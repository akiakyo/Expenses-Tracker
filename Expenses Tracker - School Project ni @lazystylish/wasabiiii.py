...
canvas.create_rectangle(0.0, 0.0, 800.0, 85.0, fill="#002689", outline="")
...
entry_2.place(x=51.0, y=418.0, width=500.0, height=36.0)
...
# Reset button
reset_button = Button(
    text="Reset All", command=reset_all, bg="#FFA500", fg="#FFFFFF", relief="flat"
)
